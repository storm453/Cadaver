		...
		if(j != slots_y)
		{
			...
			{	
				...
				if(global.info_sel_slot[0] != 0)
				{
					...
					{
						draw_sprite_ext(s_Slot, 3, start_x + (global.info_sel_slot[0] * slot_size * draw_scale), start_y + (global.info_sel_slot[1] * slot_size * draw_scale), draw_scale, draw_scale, 0, c_white, 1)
					}
				}
