...
{
	items_list[item.stone].item_data.item_type = item_types.ranged
	items_list[item.stone].item_data.description = "Heavy.. A very useful resource that is used in many different recipes. Pretty solid huh?"
}
...
{
	items_list[5].item_data.scrap = true
...
{
	items_list[17].item_data.item_type = item_types.consumable
	items_list[17].item_data.hp = 1
	items_list[17].item_data.energy = 3
}
