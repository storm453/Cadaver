...
//Change these values to increace the brightness. 
//IMPORTANT: Keep the DOT at the end for integers. (example 3.;)
//You can use Real values by USING the DOT like 1.5;
	lightcol.r = mult.r * 5.;
	lightcol.b = mult.b * 5.;
	lightcol.g = mult.g * 5.;
...
//You can set the overall darkness of the shader here. 0 = tranparant, 1 = black.
	float darkness = .8;
